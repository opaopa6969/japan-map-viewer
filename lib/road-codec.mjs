 ...
 */
export function createRoadsEncoder({ region, source, classLabels, withValues = false }) {
  ...
  function finish() {
    const meta = {
      ...
      classLabels, wayCount: offsets.length, nameCount: nameIdx.size,
 ...
 */
export function encodeRoads({ region, source, classLabels, ways, withValues = false }) {
  const enc = createRoadsEncoder({ region, source, classLabels, withValues });
